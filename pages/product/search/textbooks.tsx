...
import { default as productDB5 } from '@data/product-database5'
...
const SalePage1 = () => {
  ...
  const renderProductCount = () => {
    ...
    let totalProduct = productDB5.length
  ...
  useEffect(() => {
    setProductList(
      productDB5.slice(page * productPerPage, (page + 1) * productPerPage)
    )
  }, [page])
      ...
      <Container sx={{ mt: '2rem' }}>
        ...
        <Box>
          <FlexBox mb={4} flexWrap="wrap">
            <H1 color="primary.main" mr={1} lineHeight="1">
              Find a textbook on your campus,
            </H1>
        ...
        >
          ...
          <Pagination
            ...
            variant="outlined"
            color="primary"
            count={Math.ceil(productDB5.length / productPerPage)}
