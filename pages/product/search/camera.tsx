...
import { default as productDB2 } from '@data/product-database2'
...
const SalePage1 = () => {
  ...
  const renderProductCount = () => {
    ...
    let totalProduct = productDB2.length
  ...
  useEffect(() => {
    setProductList(
      productDB2.slice(page * productPerPage, (page + 1) * productPerPage)
    )
  }, [page])
      ...
      <Container sx={{ mt: '2rem' }}>
        ...
        >
          ...
          <Pagination
            ...
            variant="outlined"
            color="primary"
            count={Math.ceil(productDB2.length / productPerPage)}
