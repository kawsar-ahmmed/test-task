...
import { default as productDB6 } from '@data/product-database6'
...
const SalePage1 = () => {
  ...
  const renderProductCount = () => {
    ...
    let totalProduct = productDB6.length
  ...
  useEffect(() => {
    setProductList(
      productDB6.slice(page * productPerPage, (page + 1) * productPerPage)
    )
  }, [page])
      ...
      <Container sx={{ mt: '2rem' }}>
        ...
        >
          ...
          <Pagination
            ...
            variant="outlined"
            color="primary"
            count={Math.ceil(productDB6.length / productPerPage)}
