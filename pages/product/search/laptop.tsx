...
import { default as productDB4 } from '@data/product-database4'
...
const SalePage1 = () => {
  ...
  const renderProductCount = () => {
    ...
    let totalProduct = productDB4.length
  ...
  useEffect(() => {
    setProductList(
      productDB4.slice(page * productPerPage, (page + 1) * productPerPage)
    )
  }, [page])
      ...
      <Container sx={{ mt: '2rem' }}>
        ...
        >
          ...
          <Pagination
            ...
            variant="outlined"
            color="primary"
            count={Math.ceil(productDB4.length / productPerPage)}
