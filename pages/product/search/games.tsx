...
import { default as productDB3 } from '@data/product-database3'
...
const SalePage1 = () => {
  ...
  const renderProductCount = () => {
    ...
    let totalProduct = productDB3.length
  ...
  useEffect(() => {
    setProductList(
      productDB3.slice(page * productPerPage, (page + 1) * productPerPage)
    )
  }, [page])
      ...
      <Container sx={{ mt: '2rem' }}>
        ...
        >
          ...
          <Pagination
            ...
            variant="outlined"
            color="primary"
            count={Math.ceil(productDB3.length / productPerPage)}
