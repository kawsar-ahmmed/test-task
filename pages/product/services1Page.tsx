...
import ProductDescription10 from '@component/products/ProductDescription10'
import ProductIntro10 from '@component/products/ProductIntro10'
...
const ProductDetails = () => {
  ...
  return (
    <NavbarLayout>
      ...
      <Box mb={6}>
        {selectedOption === 0 && <ProductDescription10 />}
