...
export interface ProductReview2Props {}

const ProductReview2: React.FC<ProductReview2Props> = () => {
...
const commentList = [
  {
    ...
    date: '2021-02-14',
    comment:
      ' Smooth experience. No issues. 5 stars!',
  },
  {
    name: 'Hongyuen M.',
    ...
    date: '2021-07-15',
    comment:
      'Gave it 4 stars only because I had some issues returning the console',
  },
  {
    name: 'Vanessa Hogdeen',
    imgUrl: '/assets/images/faces/8.png',
    rating: 4.0,
    date: '2021-02-05',
    comment:
      'FYI- You have to provide your own games! :) ',
  },
]
