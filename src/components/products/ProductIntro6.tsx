...
export interface ProductIntro6Props {
  imgUrl?: string[]
  title: string
  price: number
  id?: string | number
...
const ProductIntro6: React.FC<ProductIntro6Props> = ({
  imgUrl = [],
  title,
  price = 200,
  id,
      ...
      <Grid container spacing={3} justifyContent="space-around">
        ...
        <Grid item md={6} xs={12} alignItems="center">
          ...
          <FlexBox alignItems="center" mb={2}>
            <Box>Location:</Box>
            <H6 ml={1}>Morgan State University | Univ. of Maryland | Towson Univ.</H6>
          </FlexBox>
...
ProductIntro6.defaultProps = {
  imgUrl: [
    '/assets/images/products/calculus.jpg',
  ],
  title: 'PS5 Console',
  price: 50,
}

export default ProductIntro6