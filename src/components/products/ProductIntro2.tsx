...
export interface ProductIntro2Props {
  imgUrl?: string[]
  title: string
  price: number
  id?: string | number
...
const ProductIntro2: React.FC<ProductIntro2Props> = ({
  imgUrl = [],
  title,
  price = 200,
  id,
...
ProductIntro2.defaultProps = {
  imgUrl: [
    '/assets/images/products/ps5.jpg',
    '/assets/images/products/ps5_2.jpg',
  ],
  title: 'PS5 Console',
  price: 50,
}

export default ProductIntro2