...
export interface ProductIntro3Props {
  imgUrl?: string[]
  title: string
  price: number
  id?: string | number
...
const ProductIntro3: React.FC<ProductIntro3Props> = ({
  imgUrl = [],
  title,
  price = 200,
  id,
...
ProductIntro3.defaultProps = {
  imgUrl: [
    '/assets/images/products/ee_book.jpg',
  ],
  title: 'PS5 Console',
  price: 50,
}

export default ProductIntro3