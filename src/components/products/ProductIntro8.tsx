...
export interface ProductIntro8Props {
  imgUrl?: string[]
  title: string
  price: number
  id?: string | number
...
const ProductIntro8: React.FC<ProductIntro8Props> = ({
  imgUrl = [],
  title,
  price = 15,
  id,
...
ProductIntro8.defaultProps = {
  imgUrl: [
    '/assets/images/products/cal1.jpg',
  ],
  title: 'Intro to Calculus',
  price: 15,
}

export default ProductIntro8