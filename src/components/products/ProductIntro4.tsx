...
export interface ProductIntro4Props {
  imgUrl?: string[]
  title: string
  price: number
  id?: string | number
...
const ProductIntro4: React.FC<ProductIntro4Props> = ({
  imgUrl = [],
  title,
  price = 200,
  id,
      ...
      <Grid container spacing={3} justifyContent="space-around">
        ...
        <Grid item md={6} xs={12} alignItems="center">
          ...
          <FlexBox alignItems="center" mb={2}>
            <Box>Location:</Box>
            <H6 ml={1}>Univ. of Maryland | Morgan State University | Towson University</H6>
          </FlexBox>
...
ProductIntro4.defaultProps = {
  imgUrl: [
    '/assets/images/products/xbox.jpeg',
  ],
  title: 'XBOX Series X',
  price: 25,
}

export default ProductIntro4