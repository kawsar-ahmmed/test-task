...
export interface ProductIntro5Props {
  imgUrl?: string[]
  title: string
  price: number
  id?: string | number
...
const ProductIntro5: React.FC<ProductIntro5Props> = ({
  imgUrl = [],
  title,
  price = 200,
  id,
      ...
      <Grid container spacing={3} justifyContent="space-around">
        ...
        <Grid item md={6} xs={12} alignItems="center">
          ...
          <FlexBox alignItems="center" mb={2}>
            <Box>Available At:</Box>
            <H6 ml={1}>Univ. of Maryland | Towson University | Morgan State University</H6>
          </FlexBox>
...
ProductIntro5.defaultProps = {
  imgUrl: [
    '/assets/images/products/macbook_2.jpeg',
  ],
  title: 'PS5 Console',
  price: 50,
}

export default ProductIntro5