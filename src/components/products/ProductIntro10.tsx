...
export interface ProductIntro10Props {
  imgUrl?: string[]
  title: string
  price: number
  id?: string | number
...
const ProductIntro10: React.FC<ProductIntro10Props> = ({
  imgUrl = [],
  title,
  price = 15,
  id,
        ...
        <Grid item md={6} xs={12} alignItems="center">
          ...
          <Box mb={3}>
            <H2 color="primary.main" mb={0.5} lineHeight="1">
              ${price.toFixed(2)}
              <Box color="inherit">Per Hour</Box>
            </H2>
...
ProductIntro10.defaultProps = {
  imgUrl: [
    '/assets/images/products/barber1.png',
  ],
  title: 'Mobile Barber',
  price: 15,
}

export default ProductIntro10