          ...
          <Box py={10} overflow="hidden">
            <Grid container spacing={3}>
              <Grid item lg={4} md={6} sm={6} xs={12}>
                <Link href="/">
                  <a>
                  <Image height={150} mb={2.5} src="/assets/images/sharestashlogo.svg" alt="logo" />
                  </a> 
                </Link>
              ...
              <Grid item lg={3} md={6} sm={6} xs={12}>
                ...
                <Box py={0.6} color="grey.500">
                  2300 Georgia Ave NW, Washington, DC 20001, United States
                </Box>
                <Box py={0.6} color="grey.500">
                  Email: support@sharestash.io
                </Box>
                <Box py={0.6} mb={2} color="grey.500">
                  Phone: +1 404 202 7806
                </Box>
